...
output_file = 'C:\\Users\\georg\\OneDrive\\Documents\\Real Life!\\Michigan\\Balbach_Lab_PostDoc\\Human_experiments\\EX_n_documentation\\EX_4_20250212_KW2\\KW2_rerun_python_output.xlsx'
...
with pd.ExcelWriter(output_file) as writer:
    for compound in df['Compound'].unique():
        ...
        pivot_df['m+0_%'] = (pivot_df['m+0'] / pivot_df['Total_Abundance'] * 100).round(2)
        pivot_df['m+1_to_m+n_%'] = ((pivot_df['Total_Abundance'] - pivot_df['m+0']) / pivot_df['Total_Abundance'] * 100).round(2)

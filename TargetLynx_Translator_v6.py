...
# File paths
input_file = 'C:\\Users\\\eorg\\OneDrive\\Documents\\Real Life!\\Michigan\\Balbach_Lab_PostDoc\Human_experiments\EX_n_documentation\EX_9_20250320_CK4\250327_CK4_KW3_export.txt'
output_file = 'C:\' \
    '
# Data storage
data = []
...
with open(input_file, 'r') as file:
    for line in file:
        ...
        if len(fields) >= 8:
            # Exclude blanks, media control, HEK, media, and medcon samples
            if any(term in fields[2].lower() for term in ['blank', 'mediacontrol', 'hek', 'media', 'medcon']):
                continue

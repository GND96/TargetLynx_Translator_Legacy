...
output_file = 'C:\\Users\\georg\\OneDrive\\Documents\\Real Life!\\Michigan\\Balbach_Lab_PostDoc\\Human_experiments\\EX_n_documentation\\EX_3_20250205\\formatted_results_pythonoutput2.xlsx'
...
with open(input_file, 'r') as file:
    for line in file:
        ...
        if len(fields) >= 8:
            ...
            # Extract base compound name without isotopologue
